...
/*
	...
	DSL-Display-1    ---> the big one
	DSL-Display-2 & DSL-Display-3  ---> the carts

	There also should be zones as channels:

	DSL-Display-Zone-1 ... 12  (main display)
	DSL-Display-Zone-13, 14    (carts, same as DSL-Display-1 & 2)

	How many zones are in the main display? (60 total - each could be a div or iframe)
...
$app_id = '35667';
$app_key = 'ccd0e24bbd911bcef19d';
$app_secret = '802cd01e2ae6e2342038';

// test for demo: http://localhost/DieSeL/send-message/?recipient=wall-demo&name=show_details&data=789

$recipient = $_GET['recipient'];
$messageName = $_GET['name'];
$data = $_GET['data'];

$pusher = new Pusher( $app_key, $app_secret, $app_id );

$pusher->trigger($recipient, $messageName, $data);

echo "Recipient: " . $recipient . " -- Message name: " . $messageName . " -- data: " . $data;